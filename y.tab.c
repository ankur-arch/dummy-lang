...
{
  "$end", "error", "$undefined", "FNUM", "';'", "'+'", "'-'", "'*'",
  "'/'", "'('", "')'", "$accept", "M", "S", "E", "F", "G", "T", YY_NULLPTR
};
#endif
...
{
       0,    14,     0,     0,     0,     0,     4,     7,     9,    11,
      13,     0,     1,     0,     2,     0,     0,     0,     0,    12,
       3,     5,     6,     8,    10
};
...
{
      10,    12,     1,    17,     1,     2,    14,     2,     3,    20,
       3,    11,    15,    16,    15,    16,    24,    19,    21,    22,
      18,    13,     0,    23
};
...
{
       0,     3,     6,     9,    12,    13,    14,    15,    16,    17,
      17,    14,     0,    13,     4,     5,     6,     7,     8,    10,
       4,    15,    15,    16,    17
};
